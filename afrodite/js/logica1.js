    ...
    for (var id_for of partes) {
      ...
      for (var p of dados.detalhes) {
        ...
        if (p.id == id_for) {
          ...
          var lin = '<div class="produto"> <img id="imagem" src="' + p.nome_imagem + '" title="foto carrinho"> <div class="info"> <p>' + p.descricao + '</p><p> SITUAÇÃO: SEMINOVO </p><p> VERDE </p><label class="checkbox"><input type="checkbox" id="checkbox" value=""></label></div></div><br>';
