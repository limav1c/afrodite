    ...
    for (var id_for of partes) {
      ...
      for (var p of dados.detalhes) {
        ...
        if (p.id == id_for) {
          ...
          var img = src=`<img id="imagem" src="C:/Users/maria/Downloads/kely/kmelo/testes-main/afrodite/${p.nome_imagem}" title="foto carrinho>`
          var lin = '<div class="produto"> ' + img + ' <div class="info"> <p>' + p.descricao + '</p><p> SITUAÇÃO: SEMINOVO </p><label class="checkbox"><input type="checkbox" id="checkbox" value=""></label></div></div><br>';
